                    ...
                    <?php foreach ($latest as $index => $artikel) : ?>
                        <div class="carousel-item <?= $index === 0 ? 'active' : '' ?>">
                            ...
                            <div class="carousel-caption d-none d-md-block">
                                <h5 class="text-light d-inline" style="filter: drop-shadow(0 0 4px #000);"><?= $artikel['judul'] ?></h5>
                                <br>
                                <p class="text-light d-inline" style="filter: drop-shadow(0 0 4px #000);"><?= $artikel['name'] ?></p>
                            </div>
                        </div>
                    <?php endforeach ?>
                </div>
